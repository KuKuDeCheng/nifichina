...
**Replacement Strategy** | Regex Replace |  <li>Prepend  <li>Append  <li>Regex Replace  <li>Literal Replace <li>Always Replace  | 在流文件的文本内容中如何替换以及替换什么内容的策略。                                                                                                                                                                                                                                                                   
**Evaluation Mode**      | Entire text   | <li> Line-by-Line <li>Entire text                                               | 对每一行单独进行“替换策略”(Line-by-Line)；或将整个文件缓冲到内存中(Entire text)，然后对其进行“替换策略”。                                                                                                                                                                                                                                              
